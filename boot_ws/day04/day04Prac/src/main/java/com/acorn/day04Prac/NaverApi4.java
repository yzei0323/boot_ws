...
public class NaverApi4 {
    ...
    public List<ItemDTO> getItemDTOS(String data) {
        //
        //0. api로부터 데이터 받아오기
        //1. 원하는 데이터 꺼내기
        ...
        //- jsonArray 반복하면서 자바 ItemDTO로 변환하기
    ...
    public String getData() {
        String clientId = "4eJ2nBcIPiMJapR7B49l"; //애플리케이션 클라이언트 아이디
        String clientSecret = "ne_hjdKscT"; //애플리케이션 클라이언트 시크릿


        String text = null;
        try {
            text = URLEncoder.encode("엔시티", "UTF-8");
